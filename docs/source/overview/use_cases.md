...
Nipoppy can help with many use cases related to data curation and processing. The modular design of Nipoppy offers a variety of entry points for Nipoppy adoption suitable for your workflows and analysis.
...
- Nipoppy touchpoints:
    ...
    - Files: {term}`manifest.tsv <Manifest file>`, {term}`global_config.json <Global config file>`, {term}`invocation.json <Boutiques>`, {term}`doughnut.tsv <Doughnut file>`
...
- Nipoppy touchpoints:
    ...
    - Files: {term}`manifest.tsv <Manifest file>`, {term}`global_config.json <Global config file>`, demographics.tsv, phenotypic_bagel.tsv
...
- Nipoppy touchpoints:
    ...
    - Files: {term}`manifest.tsv <Manifest file>`, {term}`global_config.json <Global config file>`, {term}`invocation.json <Boutiques>`, {term}`tracker_config.json <Tracker config file>`, {term}`imaging_bagel.tsv <Imaging bagel file>`
...
- Nipoppy touchpoints:
    - Commands: [run](../cli_reference/run.rst), [track](../cli_reference/track.rst)
    - Files: {term}`manifest.tsv <Manifest file>`, {term}`global_config.json <Global config file>`, {term}`descriptor.json <Boutiques>`, {term}`invocation.json <Boutiques>`, {term}`pybids_ignore.json <Pybids ignore file>`, {term}`tracker_config.json <Tracker config file>`, {term}`imaging_bagel.tsv <Imaging bagel file>`
...
- Nipoppy touchpoints:
    ...
    - Files: {term}`manifest.tsv <Manifest file>`, {term}`global_config.json <Global config file>`, {term}`descriptor.json <Boutiques>`, {term}`invocation.json <Boutiques>`, {term}`imaging_bagel.tsv <Imaging bagel file>`
